...
<li><?= $this->Html->link(__('Link Confirm'), ['action' => 'index', uniqid()], [
        'confirm' => "Would like to do a round trip to this page with a GET request?",
        'class' => 'nav-link',
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        [
                            'confirm' => __('Are you sure you want to delete # {0}?', $article->name),
                            'title' => __('Delete'),
